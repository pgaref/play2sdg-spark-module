...
//		}
	...
	public static void main(String[] args) {
		System.out.println("Tacks Counter: "+ CassandraController.getCounterValue("tracks"));
		System.out.println("Looking for user pgaref : found =  "+ CassandraController.findbyEmail("pgaref@example.com").toString());
	}
}