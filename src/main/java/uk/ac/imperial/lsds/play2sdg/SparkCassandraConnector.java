...
public class SparkCassandraConnector implements Serializable {
    ...
    public SparkCassandraConnector() {
    	...
    	SparkConf conf = new SparkConf()
			...
			.setMaster("local")
			//.set("spark.cassandra.keyspace ", "demo")
        ...
        sc.setLocalProperty("spark.cassandra.connection.host", "127.0.0.1");
        sc.setLocalProperty("spark.cassandra.keyspace ", "demo");
