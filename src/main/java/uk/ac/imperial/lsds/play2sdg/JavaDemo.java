...
public class JavaDemo implements Serializable {
    ...
    private void generateData(JavaSparkContext sc) {
        ...
        System.out.println("#### Persisting 'products' to Cassandra");
        ...
        System.out.println("#### Persisting 'sales' to Cassandra");
    }
    ...
    private void compute(JavaSparkContext sc) {
        ...
        System.out.println("#### Persisting 'summaries' to Cassandra");
    }
