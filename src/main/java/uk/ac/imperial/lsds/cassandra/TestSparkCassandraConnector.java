...
public class SparkCassandraConnector implements Serializable {
	    ...
	    private void generateData(JavaSparkContext sc) {
	        ...
	        CassandraJavaUtil.javaFunctions(productsRDD).writerBuilder("java_api", "products", mapToRow(Product.class) ).saveToCassandra();
	        ...
	        CassandraJavaUtil.javaFunctions(salesRDD).writerBuilder("java_api", "sales", mapToRow(Sale.class) ).saveToCassandra();
	    }
	    ...
	    private void compute(JavaSparkContext sc) {
	        ...
	        JavaPairRDD<Integer, Sale> salesRDD = javaFunctions(sc)
	                .cassandraTable("java_api", "sales", mapColumnTo(Sale.class) )
	        ...
	        CassandraJavaUtil.javaFunctions(summariesRDD).writerBuilder("java_api", "summaries", mapToRow(Summary.class) ).saveToCassandra();
	    }
	 
	    private void showResults(JavaSparkContext sc) {
	        JavaPairRDD<Integer, Summary> summariesRdd = javaFunctions(sc)
	                .cassandraTable("java_api", "summaries", mapColumnTo(Summary.class))
